# -*- coding: utf-8 -*-
"""mini35_probe.py — v13.57 재확인 2문항(T6·T11·M2).
사용: python mini35_probe.py && python claim_check.py mini35_out.txt && python cite_check.py mini35_out.txt"""
...
def main():
    ...
    for qid, q, chk in Q:
        ...
        ft.write(f"\n{'='*70}\n[{qid}] {q}\n판정: {f or 'OK'}\n--- trace ---\n{tr}\n--- 답변 ---\n{a}\n"); time.sleep(0.5)
    ft.close(); print("=" * 50); print("2문항 모두 OK" if not bad else f"확인 필요 {bad}문항 → mini35_out.txt (판정 표시는 후보일 뿐, 원문 확인 필요)")
